    ...
    <div class="col-12">
      <div class="card mb-4">
        <div class="card-header pb-0 d-flex justify-content-between align-items-center">
          <h6>User Tables</h6>
          <a class="btn btn-outline-primary btn-sm mb-0 me-3" href="{{url('/users/create')}}">Tambah User</a> 
      </div>
            ...
            <tbody>
                @foreach($user as $data)
                    <tr>
                        ...
                        <td class="align-middle text-sm">
                            <p class="text-xs font-weight-bold mb-0">{{ $data->created_by == null ? "kosong" : $data->created_by }}</p>
                        </td>
